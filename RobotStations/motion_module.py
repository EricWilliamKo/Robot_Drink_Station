...
class MotionModule:
    ...
    def toD3I(self,wtime):
        pose = '#1P2114#2P1550#3P538#4P1949'
        cmd = pose + 'T' + wtime
        self.sendCmdThread([cmd])
    ...
    def pullCup(self):
        cmdList = [
            '#1P1993#2P1058#3P2150#4P1094#5P1500#6P1580T2000',
            '#1P1993#2P1179#3P2414#4P958#5P1500T2000'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
    ...
    def putS2(self):
        cmdList = [
            '#1P1735#2P1079#3P2300#4P848#5P1500T1000',
            '#1P1765#2P935#3P1864#4P1131#5P1500T1000',
            '#6P1050T500',
    ...
    def getS2(self):
        cmdList = [
            ...
            '#6P1590T500',
            '#1P1765#2P993#3P2053#4P950#5P1500T1500',
    ...
    def putS3(self):
        cmdList = [
            '#1P1356#2P1140#3P2408#4P828#5P1500T1000',
            '#1P1356#2P1023#3P2125#4P1021#5P1500T3000',
            '#6P1050T500',
            '#1P1356#2P1040#3P2231#4P911#5P1500T1000',
    ...
    def getS3(self):
        cmdList = [
            ...
            '#1P1356#2P1023#3P2125#4P1021#5P1500T3000',
            '#6P1590T500',
            '#1P1356#2P1085#3P2312#4P838#5P1500T1000',
            '#1P1356#2P1150#3P2334#4P886#5P1500T1000'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
    ...
    def putS4(self):
        cmdList = [
            '#1P1093#2P1133#3P2388#4P848#5P1500T3000',
            '#1P1093#2P935#3P1864#4P1131#5P1500T1000',
            '#6P1050T500',
    ...
    def getS4(self):
        cmdList = [
            ...
            '#1P1093#2P955#3P1886#4P1180#5P1500#6P1050T1000',
            '#6P1590T500',
            '#1P1093#2P993#3P2053#4P950#5P1500T1500',
    ...
    def putS5(self):
        cmdList = [
            '#1P963#2P1133#3P2388#4P848#5P1500T3000',
            '#1P963#2P960#3P2078#4P965#5P1500T1000',
            '#6P1050T500',
            '#1P963#2P1033#3P2153#4P1000#5P1500T700',
    ...
    def getS5(self):
        cmdList = [
            ...
            '#6P1590T500',
            '#1P963#2P1048#3P2153#4P1000#5P1500T500',
            '#1P963#2P1133#3P2388#4P848#5P1500T1000'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
    ...
    def putS6(self):
        cmdList = [
            ...
            '#1P768#2P1094#3P2381#4P828#5P1500T1000',
            '#6P1050T500',
            '#1P768#2P1194#3P2475#4P828#5P1500T1000',
    ...
    def getS6I(self):
        cmdList = [
            '#1P2114#2P1762#3P528#4P2117#5P1500#6P1050T2000',
            '#6P1590T500',
            '#1P2114#2P1764#3P558#4P2117#5P1500T1000',
            '#1P2114#2P1540#3P538#4P1949#5P1500T1000'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
    ...
    def putL1(self):
        cmdList = [
            '#1P1513#2P1815#3P882#4P1881#5P1500T2000',
            '#1P1513#2P2038#3P1159#4P1758#5P1500T1000',
            '#6P1050T500',
            '#1P1513#2P1806#3P768#4P2042#5P1500T700'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
    ...
    def putL2(self):
        cmdList = [
            '#1P1414#2P1806#3P768#4P2042#5P1500T2000',
            '#1P1414#2P1891#3P1014#4P1763#5P1500T700',
            '#1P1414#2P2117#3P1387#4P1604#5P1500T700',
            '#6P1050T500',
    ...
    def putL3(self):
        cmdList = [
            '#1P1319#2P1815#3P882#4P1881#5P1500T2000',
            '#1P1319#2P2038#3P1159#4P1823#5P1500T1000',
            '#6P1050T500',
            '#1P1319#2P1806#3P768#4P2042#5P1500T700'
        ]
        self.sendCmdThread(cmdList)
        return self.workingtime(cmdList)
